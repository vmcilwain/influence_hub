...
ActiveRecord::Schema[8.0].define(version: 2024_12_16_182920) do
  ...
  create_table "organizations", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["campaign_id"], name: "index_organizations_on_campaign_id"
  ...
  add_foreign_key "organizations", "campaigns"
